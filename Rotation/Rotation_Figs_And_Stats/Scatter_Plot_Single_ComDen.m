...
RealHubs = ft_read_cifti_mod(['/!!Your Path Here!!/CommDenAD_5mm_ROIs.dtseries.nii']);
...
%Split by hemi%
OrigRightHub=[1,2,4,8];
OrigLeftHub=[3,5,6,7,9,10];
RightHub=RealHubAveValOverlap([1,2,4,8]);
LeftHub=RealHubAveValOverlap([3,5,6,7,9,10]);
%Calc Rot Overlap%
...
saveas(1,['/!!Your Path Here!!/',FileName,'_CD_Hub ',char(num2str(HubName)),'_IndivPar.jpg']);
