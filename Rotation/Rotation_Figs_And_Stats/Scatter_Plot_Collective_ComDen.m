...
load('/!!Your Path Here!!/GoodComDen.mat'); %Load desired output file from GoodFiltApril2022.m
...
saveas(1,['/!!Your Path Here!!/',FileName,'_July_Hub_CD.jpg']);
